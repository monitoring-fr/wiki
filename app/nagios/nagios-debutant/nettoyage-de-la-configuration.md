---
layout: page
title: Nettoyage de la configuration post-install
---
...
Maintenant, vous avez des templates et un localhost tout propre et simple pour débuter. Maintenant, il faut passer à la création d’un hôte.